      ...
      <div class="table-wp">
        ...
        <div class="btn-wp">
          <el-button
            v-if="
              typeVal == 1 &&
                $menu.getters.judgeRole('Btn-wbkTqEEeKP2s8f2nD4f22r23')
            "
            ...
            @click="batchPrint"
          >
            打印收据已选({{ tableSelected.length }})本
          </el-button>
          <el-button
            v-if="
              typeVal != 1 &&
                $menu.getters.judgeRole('Btn-xMjCHCCFJlKaSMqnV74dnK5m')
            "
            :disabled="tableSelected.length === 0"
            class="empty"
            type="primary"
...
<script src="@/assets/assist/js/batchGathering.js"></script>

<style lang="less">
@import url('~@/assets/assist/css/batchGathering.less');
</style>
