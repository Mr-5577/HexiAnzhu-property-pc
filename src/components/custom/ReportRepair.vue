    ...
    <div class="top">
      <div class="main">
        ...
        <div class="common-right">
          <el-button
            v-if="$menu.getters.judgeRole('Btn-qf6daNAAxnS6rEWXkkU5OGEj')"
            type="primary"
            round
            plain
      ...
      <el-scrollbar style="height: 100%;" v-loading="isLoading">
        <div class="main-content" v-if="!isLoading">
          ...
          >
            ...
            <div class="btn-wp">
              <el-button
                v-if="$menu.getters.judgeRole('Btn-Xi6k5l674JlANH3j1h8ctXgL')"
                :loading="isCommit"
                type="primary"
                round
                @click="sendOrders"
          ...
          >
            ...
            <div class="btn-wp">
              <el-button
                v-if="$menu.getters.judgeRole('Btn-aF3htIiAtZMrlPeLGvnA81ip')"
                :loading="isCommit"
                type="primary"
                round
                @click="reassignOrder"
          ...
          >
            ...
            <div class="btn-wp">
              <el-button
                v-if="$menu.getters.judgeRole('Btn-Mc1aCvqR8rOMM2ceXcI1xwkv')"
                :loading="isCommit"
                type="primary"
                round
                @click="returnVisit"
          ...
          >
            ...
            <div class="btn-wp">
              <el-button
                v-if="$menu.getters.judgeRole('Btn-8A7oKrEszJQpHcQ8pb2gM52y')"
                :loading="isCommit"
                type="primary"
                round
                @click="handleFinish"
...
<script src="@/assets/custom/js/reportRepair.js"></script>

<style lang="less">
@import url('~@/assets/custom/css/reportRepair.less');
</style>
